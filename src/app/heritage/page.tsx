...
export default function HeritagePage() {
  ...
  const milestones = [
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1587836374062-d60746f3c049?auto=format&fit=crop&q=80&w=800',
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-black text-white">
      ...
      >
        ...
        >
          <Image
            src="https://images.unsplash.com/photo-1611004229098-808066b0f3fd?auto=format&fit=crop&q=80"
